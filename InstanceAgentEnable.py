################################################################################################################################
## The script goes through all the compartments in the Subscribed Regions and enables the Vulnerability Scanning agent
...
for region in regions:
    ...
    for a, instances in enumerate(list_instances):
        ...
        x.add_row([ root_compartment.data.name, region.region_name, instances.display_name, instances.availability_domain, instances.fault_domain, instances.lifecycle_state, instances.shape, instances.shape_config.ocpus, instances.shape_config.memory_in_gbs, instances.time_maintenance_reboot_due   ])
